...
export default function AgentsAddPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <ProductNotice note={t("agents_add.notice")} />

      <div className="flex flex-wrap gap-3 text-sm">
        <Link href="/agent-fleet" className="text-zinc-700 underline">
          ← {t("nav.agents")}
        </Link>
        <Link href="/local-bridge?connect=1" className="text-zinc-700 underline">
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-4 space-y-4" data-testid="agents-add-form">
        ...
        >
          ...
          <p className="mt-2 text-xs text-amber-900/80">
            {t("agents_add.completion_mode")}: {t(COMPLETION_MODE_TITLE_KEYS[tpl.completion_mode])}
          </p>
        </div>
